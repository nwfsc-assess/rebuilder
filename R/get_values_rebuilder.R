#' Pull output from Rebuilder program RES.CSV fle
#'
#'
#'
#' @param dir Directory where rebuilder output
#' files are stored.
#' @param num_rows Number of columns in the csv file to be read
#' @author Chantel Wetzel
#' @export

get_values <- function(dir, num_rows = 200) {

	res <-  readLines(file.path(dir, "RES.CSV"))
